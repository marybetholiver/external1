...
INLINE bool IsStereoEyeLeft()
{
	...
	return false;
#elif defined(UNITY_SINGLE_PASS_STEREO) || defined (UNITY_STEREO_INSTANCING_ENABLED) || defined(USING_STEREO_MATRICES)
	...
	float dRight = distance(_WorldCameraPosition + _WorldCameraRight, renderCameraPos);
	float dLeft = distance(_WorldCameraPosition - _WorldCameraRight, renderCameraPos);
